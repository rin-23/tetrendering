...
ES2VisualEffectSPtr ES2CoreVisualEffects::VideoTexture() 
{
    ...
    effect->AlphaStateEnabled = true;
    effect->DepthStateEnabled = false;
...
ES2VisualEffectSPtr ES2CoreVisualEffects::MatCap()
{
    ES2ShaderProgram* shader = new ES2ShaderProgram();
    shader->LoadProgram(GetFilePath("matcap", "vs"), GetFilePath("matcap", "fs"));
    ...
    uniforms->SetUniform(0, shader->GetUniformLocation("uMVPMatrix"), 1, "uMVPMatrix", ES2ShaderUniforms::UniformMatrix4fv);
    // uniforms->SetUniform(1, shader->GetUniformLocation("uMVMatrix"), 1, "uMVMatrix", ES2ShaderUniforms::UniformMatrix4fv);
    uniforms->SetUniform(1, shader->GetUniformLocation("uNMatrix"), 1, "uNMatrix", ES2ShaderUniforms::UniformMatrix3fv);
    uniforms->SetUniform(2, shader->GetUniformLocation("tMatCap"), 1, "tMatCap", ES2ShaderUniforms::Uniform1iv);
...
ES2VisualEffectSPtr ES2CoreVisualEffects::WireframeColor() 
{
    ...
    // #ifdef ENABLE_MKL
    // shader->LoadProgram("/home/rinat/Workspace/MuscleGeometrySrc2/MuscleGeometrySrc/libigl-muscles/minityro/Shaders/WireframeColor.vsh", "/home/rinat/Workspace/MuscleGeometrySrc2/MuscleGeometrySrc/libigl-muscles/minityro/Shaders/WireframeColor.fsh");
    // #else
    shader->LoadProgram(GetFilePath("WireframeColor", "vsh"), GetFilePath("WireframeColor", "fsh"));
    // #endif
    ES2VertexFormat* vertexFormat = new ES2VertexFormat(2);
