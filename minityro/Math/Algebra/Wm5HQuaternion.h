...
public:
    ...
    void ToRotationMatrix (Matrix3f& rot) const;
    ...
    void ToAxes(AVector* axes) const;
    ...
    APoint Rotate (const APoint& point) const;
    ...
    // V2 = (x2,y2,z2).
    HQuaternion& Align (const AVector& v1, const AVector& v2);
