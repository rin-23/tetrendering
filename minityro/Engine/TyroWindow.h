...
{   
    ...
    public:
        ...
        inline GLFWcursor* GetPENcursor() { return m_gl_pen_cursor; }
        inline GLFWcursor* GetXcursor() { return m_gl_x_cursor; }
    ...
    private:
        ...
        GLFWcursor* m_gl_pen_cursor;
        GLFWcursor* m_gl_x_cursor;
    };
