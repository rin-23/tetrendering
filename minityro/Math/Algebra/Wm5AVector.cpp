...
const AVector AVector::UNIT_NEGATIVE_Z(0.0f, 0.0f, -1.0f);
...
//----------------------------------------------------------------------------
AVector::AVector (Vector3f&& tuple)
{
    mTuple[0] = tuple[0];
    mTuple[1] = tuple[1];
    mTuple[2] = tuple[2];
...
//----------------------------------------------------------------------------
AVector& AVector::operator= (AVector&& vec)
{
    mTuple[0] = vec.mTuple[0];
    mTuple[1] = vec.mTuple[1];
    mTuple[2] = vec.mTuple[2];
...
//----------------------------------------------------------------------------
AVector AVector::operator+ (AVector&& vec) const
{
    return AVector
    (
     mTuple[0] + vec.mTuple[0],
...
//----------------------------------------------------------------------------
float AVector::Dot (AVector&& vec) const
{
    float dotProduct = mTuple[0]*vec.mTuple[0] + mTuple[1]*vec.mTuple[1] +
    mTuple[2]*vec.mTuple[2];
...
//----------------------------------------------------------------------------
AVector AVector::GetNormalized (const float epsilon) const
{
    AVector v = AVector(mTuple);
    v.Normalize(epsilon);
    return v;
}
//----------------------------------------------------------------------------
...
//----------------------------------------------------------------------------
AVector AVector::Cross (AVector&& vec) const
{
    return AVector
    (
     mTuple[1]*vec.mTuple[2] - mTuple[2]*vec.mTuple[1],
...
//----------------------------------------------------------------------------
AVector AVector::UnitCross (AVector&& vec) const
{
    AVector cross
    (
     mTuple[1]*vec.mTuple[2] - mTuple[2]*vec.mTuple[1],
