...
//----------------------------------------------------------------------------
APoint& APoint::operator= (APoint&& pnt)
{
    mTuple[0] = pnt.mTuple[0];
    mTuple[1] = pnt.mTuple[1];
    mTuple[2] = pnt.mTuple[2];
...
//----------------------------------------------------------------------------
AVector APoint::operator- (APoint&& pnt) const
{
    return AVector
    (
     mTuple[0] - pnt.mTuple[0],
...
//----------------------------------------------------------------------------
APoint APoint::operator+ (AVector&& vec) const
{
    return APoint
    (
     mTuple[0] + vec[0],
...
//----------------------------------------------------------------------------
APoint& APoint::operator+= (AVector&& vec)
{
    mTuple[0] += vec[0];
    mTuple[1] += vec[1];
    mTuple[2] += vec[2];
...
//----------------------------------------------------------------------------
APoint APoint::operator+ (APoint&& pnt) const
{
    return APoint
    (
     mTuple[0] + pnt.mTuple[0],
