...
namespace tyro
{
    ...
    public:
        Camera();
        Camera(const Wm5::APoint& position, const Eigen::Vector4i& viewport, float aspect, bool isOrtho);
        Camera(const Wm5::APoint& position, const Wm5::APoint& target, const Eigen::Vector4i& viewport, float aspect, bool isOrtho);
        virtual ~Camera();
        ...
        inline const Eigen::Vector4i& GetViewport() const;
...
//        void SetGyroscopeRotationEnabled(bool enable);
        ...
        Eigen::Matrix4f GetEigenViewMatrix() const;
        Eigen::Matrix4f GetEigenProjMatrix() const;
        Eigen::Matrix3f GetEigenNormalMatrix() const;
        Eigen::Vector4f GetEigenViewport() const;
    ...
    const Eigen::Vector4i& Camera::GetViewport() const
    {
        return mViewport;
    }
