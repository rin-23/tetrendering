...
namespace tyro
{
    ...
    using AnchorMeshSPtr = std::shared_ptr<AnchorMesh>;
    using TetGenObjSPtr = std::shared_ptr<TetGenObj>;
    using WireMeshSPtr = std::shared_ptr<WireMesh>;
    using MeshSliceSPtr = std::shared_ptr<MeshSlice>;
    using MuscleCurveSPtr = std::shared_ptr<MuscleCurve>;
    ...
    using SkinMeshSPtr = std::shared_ptr<SkinMesh>;
    using IGLMeshTwoUPtr = std::unique_ptr<SkinMesh>;
    using IGLMeshTwoWPtr = std::weak_ptr<SkinMesh>;
    
    using MuscleCurveMeshSPtr = std::shared_ptr<MuscleCurveMesh>;
    using MusclePointSPtr = std::shared_ptr<MusclePoint>;

        
    using TetMeshSPtr = std::shared_ptr<TetMesh>;

    using BoneMeshSPtr = std::shared_ptr<BoneMesh>;
    using CurveMeshSPtr = std::shared_ptr<CurveMesh>;
