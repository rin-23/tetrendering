...
namespace tyro
{
    ...
    public:
        ...
        inline bool SetBufferTexture(ES2BufferTextureSPtr newbuf, int i);
    ...
    inline bool ES2VisualEffect::SetBufferTexture(ES2BufferTextureSPtr newbuf, int i) 
    {
        if (i >= NumBufferTextures()) 
        {
            RA_LOG_ERROR_ASSERT("not enough buffer textures");
