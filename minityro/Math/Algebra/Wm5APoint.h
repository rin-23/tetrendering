...
public:
    ...
    AVector operator- (APoint&& pnt) const;
    ...
    APoint& operator-= (const AVector& vec);
    APoint operator+ (AVector&& vec) const;
    APoint operator- (AVector&& vec) const;
    APoint& operator+= (AVector&& vec);
    APoint& operator-= (AVector&& vec);
    ...
    APoint operator+ (APoint&& pnt) const;
